...
export class SensorMultilevelV10 extends CommandClassPacket<SensorMultilevelV10Commands> {
	...
	public static readonly version: number = 10;
...
export class SensorMultilevelGet extends CommandPacket<SensorMultilevelV10SensorMultilevelGetData> {
	public static readonly CommandClass: typeof SensorMultilevelV10 = SensorMultilevelV10;
	...
	public constructor(data: Buffer | SensorMultilevelV10SensorMultilevelGetData) {
		super(SensorMultilevelGet, data);
	}
};

export class SensorMultilevelReport extends CommandPacket<SensorMultilevelV10SensorMultilevelReportData> {
	public static readonly CommandClass: typeof SensorMultilevelV10 = SensorMultilevelV10;
	...
	public constructor(data: Buffer | SensorMultilevelV10SensorMultilevelReportData) {
...
export class SensorMultilevelSupportedSensorReport extends CommandPacket<SensorMultilevelV10SensorMultilevelSupportedSensorReportData> {
	public static readonly CommandClass: typeof SensorMultilevelV10 = SensorMultilevelV10;
	...
	public constructor(data: Buffer | SensorMultilevelV10SensorMultilevelSupportedSensorReportData) {
		super(SensorMultilevelSupportedSensorReport, data);
	}
};

export class SensorMultilevelSupportedGetScale extends CommandPacket<SensorMultilevelV10SensorMultilevelSupportedGetScaleData> {
	public static readonly CommandClass: typeof SensorMultilevelV10 = SensorMultilevelV10;
	...
	public constructor(data: Buffer | SensorMultilevelV10SensorMultilevelSupportedGetScaleData) {
		super(SensorMultilevelSupportedGetScale, data);
	}
};

export class SensorMultilevelSupportedScaleReport extends CommandPacket<SensorMultilevelV10SensorMultilevelSupportedScaleReportData> {
	public static readonly CommandClass: typeof SensorMultilevelV10 = SensorMultilevelV10;
	...
	public constructor(data: Buffer | SensorMultilevelV10SensorMultilevelSupportedScaleReportData) {
