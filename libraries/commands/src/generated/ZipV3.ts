...
export class CommandZipPacket extends CommandPacket<ZipV3CommandZipPacketData> {
	public static readonly CommandClass: typeof ZipV3 = ZipV3;
	...
	public constructor(data: Buffer | ZipV3CommandZipPacketData) {
