...
const ZW_GET_NIPD_PARAMS: Parameter[] = convertFromJsonParams([
	...
	// Note: spec says that all fields MUST be interpreted as
	// in Node Information Frame (in network spec: zwave_nwk_spec).
	// In that spec, it is stated that the basicDeviceClass field
	// should only be present when the controller bit is 1.
	// If it is one, it should have a value of either 0x01 or 0x02,
	// all other values are reserved.
	// However, it seems to always be present, and has a value of
	// 0x04...
	{
		type: "Integer",
...
export function zwGetNodeInfoProtocolDataBuilder(
	...
	return () => ({
		command: SerialApiCommandCode.ZW_GET_NODE_PROTOCOL_INFO,
