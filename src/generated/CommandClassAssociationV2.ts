...
export interface AssociationSpecificGroupGet {
	_commandClass: 0x85; // (133)
	_command: 0xb; // (11)
}

export interface AssociationSpecificGroupReport {
	_commandClass: 0x85; // (133)
	_command: 0xc; // (12)
