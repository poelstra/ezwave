...
export class CommandClassBasicTariffInfoV1 {
	...
	public static readonly definition = {"id":54,"name":"COMMAND_CLASS_BASIC_TARIFF_INFO","status":"active","version":1,"commands":[{"id":1,"name":"BASIC_TARIFF_INFO_GET","status":"active","params":[]},{"id":2,"name":"BASIC_TARIFF_INFO_REPORT","status":"active","params":[{"type":"bitfield","name":"Properties1","length":1,"fields":[{"type":"integer","name":"Total No. Import Rates","mask":15,"shift":0},{"type":"integer","name":"Reserved1","mask":112,"shift":4},{"type":"bool","name":"Dual","mask":128,"shift":7}]},{"type":"bitfield","name":"Properties2","length":1,"fields":[{"type":"integer","name":"E1 Current Rate in Use","mask":15,"shift":0},{"type":"integer","name":"Reserved2","mask":240,"shift":4}]},{"type":"integer","name":"E1 Rate Consumption Register","length":4},{"type":"integer","name":"E1 Time for Next Rate Hours","length":1},{"type":"integer","name":"E1 Time for Next Rate Minutes","length":1},{"type":"integer","name":"E1 Time for Next Rate Seconds","length":1},{"type":"bitfield","name":"Properties3","length":1,"fields":[{"type":"integer","name":"E2 Current Rate in Use","mask":15,"shift":0},{"type":"integer","name":"Reserved3","mask":240,"shift":4}]},{"type":"integer","name":"E2 Rate Consumption Register","length":4}]}]};
}
