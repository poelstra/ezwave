...
export class CommandClassBasicWindowCoveringV1 {
	...
	public static readonly definition = {"id":80,"name":"COMMAND_CLASS_BASIC_WINDOW_COVERING","status":"obsolete","version":1,"commands":[{"id":1,"name":"BASIC_WINDOW_COVERING_START_LEVEL_CHANGE","status":"active","params":[{"type":"bitfield","name":"Level","length":1,"fields":[{"type":"integer","name":"Reserved1","mask":63,"shift":0},{"type":"bool","name":"Open/ Close","mask":64,"shift":6},{"type":"bool","name":"Reserved2","mask":128,"shift":7}]}]},{"id":2,"name":"BASIC_WINDOW_COVERING_STOP_LEVEL_CHANGE","status":"active","params":[]}]};
}
