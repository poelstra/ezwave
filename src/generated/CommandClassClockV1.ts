...
export class CommandClassClockV1 {
	...
	public static readonly definition = {"id":129,"name":"COMMAND_CLASS_CLOCK","status":"active","version":1,"commands":[{"id":5,"name":"CLOCK_GET","status":"active","params":[]},{"id":6,"name":"CLOCK_REPORT","status":"active","params":[{"type":"bitfield","name":"Level","length":1,"fields":[{"type":"integer","name":"Hour","mask":31,"shift":0},{"type":"integer","name":"Weekday","mask":224,"shift":5}]},{"type":"integer","name":"Minute","length":1}]},{"id":4,"name":"CLOCK_SET","status":"active","params":[{"type":"bitfield","name":"Level","length":1,"fields":[{"type":"integer","name":"Hour","mask":31,"shift":0},{"type":"integer","name":"Weekday","mask":224,"shift":5}]},{"type":"integer","name":"Minute","length":1}]}]};
}
