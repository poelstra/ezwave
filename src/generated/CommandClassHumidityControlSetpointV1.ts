...
export class CommandClassHumidityControlSetpointV1 {
	...
	public static readonly definition = {"id":100,"name":"COMMAND_CLASS_HUMIDITY_CONTROL_SETPOINT","status":"active","version":1,"commands":[{"id":1,"name":"HUMIDITY_CONTROL_SETPOINT_SET","status":"active","params":[{"type":"bitfield","name":"Properties1","length":1,"fields":[{"type":"enum","name":"Setpoint Type","mask":15,"shift":0,"values":{"1":"Humidifier","2":"Dehumidifier"}},{"type":"int","name":"Reserved","mask":240,"shift":4}]},{"type":"bitfield","name":"Properties2","length":1,"fields":[{"type":"int","name":"Size","mask":7,"shift":0},{"type":"enum","name":"Scale","mask":24,"shift":3,"values":{"0":"Percentage","1":"Absolute"}},{"type":"int","name":"Precision","mask":224,"shift":5}]},{"type":"blob","name":"Value","length":{"name":"Properties2","mask":7,"shift":0}}]},{"id":2,"name":"HUMIDITY_CONTROL_SETPOINT_GET","status":"active","params":[{"type":"bitfield","name":"Properties1","length":1,"fields":[{"type":"enum","name":"Setpoint Type","mask":15,"shift":0,"values":{"1":"Humidifier","2":"Dehumidifier"}},{"type":"int","name":"Reserved","mask":240,"shift":4}]}]},{"id":3,"name":"HUMIDITY_CONTROL_SETPOINT_REPORT","status":"active","params":[{"type":"bitfield","name":"Properties1","length":1,"fields":[{"type":"enum","name":"Setpoint Type","mask":15,"shift":0,"values":{"1":"Humidifier","2":"Dehumidifier"}},{"type":"int","name":"Reserved","mask":240,"shift":4}]},{"type":"bitfield","name":"Properties2","length":1,"fields":[{"type":"int","name":"Size","mask":7,"shift":0},{"type":"enum","name":"Scale","mask":24,"shift":3,"values":{"0":"Percentage","1":"Absolute"}},{"type":"int","name":"Precision","mask":224,"shift":5}]},{"type":"blob","name":"Value","length":{"name":"Properties2","mask":7,"shift":0}}]},{"id":4,"name":"HUMIDITY_CONTROL_SETPOINT_SUPPORTED_GET","status":"active","params":[]},{"id":5,"name":"HUMIDITY_CONTROL_SETPOINT_SUPPORTED_REPORT","status":"active","params":[{"type":"integer","name":"Bit Mask","length":0}]},{"id":6,"name":"HUMIDITY_CONTROL_SETPOINT_SCALE_SUPPORTED_GET","status":"active","params":[{"type":"bitfield","name":"Properties1","length":1,"fields":[{"type":"enum","name":"Setpoint Type","mask":15,"shift":0,"values":{"1":"Humidifier","2":"Dehumidifier"}},{"type":"int","name":"Reserved","mask":240,"shift":4}]}]},{"id":7,"name":"HUMIDITY_CONTROL_SETPOINT_SCALE_SUPPORTED_REPORT","status":"active","params":[{"type":"bitfield","name":"Properties1","length":1,"fields":[{"type":"enum","name":"Scale Bit Mask","mask":15,"shift":0,"values":{"0":"Percentage","1":"Absolute"}},{"type":"int","name":"Reserved","mask":240,"shift":4}]}]},{"id":8,"name":"HUMIDITY_CONTROL_SETPOINT_CAPABILITIES_GET","status":"active","params":[{"type":"bitfield","name":"Properties1","length":1,"fields":[{"type":"enum","name":"Setpoint Type","mask":15,"shift":0,"values":{"1":"Humidifier","2":"Dehumidifier"}},{"type":"int","name":"Reserved","mask":240,"shift":4}]}]},{"id":9,"name":"HUMIDITY_CONTROL_SETPOINT_CAPABILITIES_REPORT","status":"active","params":[{"type":"bitfield","name":"Properties1","length":1,"fields":[{"type":"enum","name":"Setpoint Type","mask":15,"shift":0,"values":{"1":"Humidifier","2":"Dehumidifier"}},{"type":"int","name":"Reserved","mask":240,"shift":4}]},{"type":"bitfield","name":"Properties2","length":1,"fields":[{"type":"int","name":"Size1","mask":7,"shift":0},{"type":"enum","name":"Scale1","mask":24,"shift":3,"values":{"0":"Percentage","1":"Absolute"}},{"type":"int","name":"Precision1","mask":224,"shift":5}]},{"type":"blob","name":"Minimum Value","length":{"name":"Properties2","mask":7,"shift":0}},{"type":"bitfield","name":"Properties3","length":1,"fields":[{"type":"int","name":"Size2","mask":7,"shift":0},{"type":"enum","name":"Scale2","mask":24,"shift":3,"values":{"0":"Percentage","1":"Absolute"}},{"type":"int","name":"Precision2","mask":224,"shift":5}]},{"type":"blob","name":"Maximum Value","length":{"name":"Properties3","mask":7,"shift":0}}]}]};
}
