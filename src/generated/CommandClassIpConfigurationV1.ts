...
export class CommandClassIpConfigurationV1 {
	...
	public static readonly definition = {"id":154,"name":"COMMAND_CLASS_IP_CONFIGURATION","status":"obsolete","version":1,"commands":[{"id":2,"name":"IP_CONFIGURATION_GET","status":"active","params":[]},{"id":4,"name":"IP_CONFIGURATION_RELEASE","status":"active","params":[]},{"id":5,"name":"IP_CONFIGURATION_RENEW","status":"active","params":[]},{"id":3,"name":"IP_CONFIGURATION_REPORT","status":"active","params":[{"type":"bitfield","name":"Properties1","length":1,"fields":[{"type":"bool","name":"Auto DNS","mask":1,"shift":0},{"type":"bool","name":"Auto IP","mask":2,"shift":1},{"type":"integer","name":"Reserved","mask":252,"shift":2}]},{"type":"integer","name":"IP Address","length":4},{"type":"integer","name":"Subnet Mask","length":4},{"type":"integer","name":"Gateway","length":4},{"type":"integer","name":"DNS1","length":4},{"type":"integer","name":"DNS2","length":4},{"type":"integer","name":"LeaseTime","length":4}]},{"id":1,"name":"IP_CONFIGURATION_SET","status":"active","params":[{"type":"bitfield","name":"Properties1","length":1,"fields":[{"type":"bool","name":"Auto DNS","mask":1,"shift":0},{"type":"bool","name":"Auto IP","mask":2,"shift":1},{"type":"integer","name":"Reserved","mask":252,"shift":2}]},{"type":"integer","name":"IP Address","length":4},{"type":"integer","name":"Subnet Mask","length":4},{"type":"integer","name":"Gateway","length":4},{"type":"integer","name":"DNS1","length":4},{"type":"integer","name":"DNS2","length":4}]}]};
}
