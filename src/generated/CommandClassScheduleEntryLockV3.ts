...
export interface ScheduleEntryLockDailyRepeatingGet {
	_commandClass: 0x4e; // (78)
	_command: 0xe; // (14)
	userIdentifier: number; // 1 byte unsigned integer
	scheduleSlotID: number; // 1 byte unsigned integer
...
export interface ScheduleEntryLockDailyRepeatingReport {
	_commandClass: 0x4e; // (78)
	_command: 0xf; // (15)
	userIdentifier: number; // 1 byte unsigned integer
	scheduleSlotID: number; // 1 byte unsigned integer
...
export interface ScheduleEntryLockDailyRepeatingSet {
	_commandClass: 0x4e; // (78)
	_command: 0x10; // (16)
	setAction: number; // 1 byte unsigned integer
	userIdentifier: number; // 1 byte unsigned integer
