...
export class CommandClassScreenAttributesV2 {
	...
	public static readonly definition = {"id":147,"name":"COMMAND_CLASS_SCREEN_ATTRIBUTES","status":"active","version":2,"commands":[{"id":1,"name":"SCREEN_ATTRIBUTES_GET","status":"active","params":[]},{"id":2,"name":"SCREEN_ATTRIBUTES_REPORT","status":"active","params":[{"type":"bitfield","name":"Properties1","length":1,"fields":[{"type":"integer","name":"Number of Lines","mask":31,"shift":0},{"type":"bool","name":"Escape Sequence","mask":32,"shift":5},{"type":"integer","name":"Reserved","mask":192,"shift":6}]},{"type":"integer","name":"Number of Characters per Line","length":1},{"type":"integer","name":"Size of Line Buffer","length":1},{"type":"integer","name":"Numerical Presentation of a Character","length":1},{"type":"integer","name":"Screen Timeout","length":1}]},{"id":3,"name":"SCREEN_ATTRIBUTES_REPORT_LEGACY","status":"active","params":[{"type":"bitfield","name":"Properties1","length":1,"fields":[{"type":"integer","name":"Number of Lines","mask":31,"shift":0},{"type":"bool","name":"Escape Sequence","mask":32,"shift":5},{"type":"integer","name":"Reserved","mask":192,"shift":6}]},{"type":"integer","name":"Number of Characters per Line","length":1},{"type":"integer","name":"Size of Line Buffer","length":1},{"type":"integer","name":"Numerical Presentation of a Character","length":1},{"type":"integer","name":"Screen Timeout","length":1}]}]};
}
...
export interface ScreenAttributesReportLegacy {
	_commandClass: 0x93; // (147)
	_command: 0x3; // (3)
	// TODO param Properties1 type bitfield
	numberOfCharactersPerLine: number; // 1 byte unsigned integer
