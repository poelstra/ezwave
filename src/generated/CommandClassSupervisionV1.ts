...
export class CommandClassSupervisionV1 {
	...
	public static readonly definition = {"id":108,"name":"COMMAND_CLASS_SUPERVISION","status":"active","version":1,"commands":[{"id":1,"name":"SUPERVISION_GET","status":"active","params":[{"type":"bitfield","name":"Properties1","length":1,"fields":[{"type":"integer","name":"Session ID","mask":63,"shift":0},{"type":"bool","name":"Reserved","mask":64,"shift":6},{"type":"bool","name":"Status Updates","mask":128,"shift":7}]},{"type":"integer","name":"Encapsulated Command Length","length":1},{"type":"blob","name":"Encapsulated Command","length":{"name":"Encapsulated Command Length","mask":255,"shift":0},"blobType":"CMD_ENCAP"}]},{"id":2,"name":"SUPERVISION_REPORT","status":"active","params":[{"type":"bitfield","name":"Properties1","length":1,"fields":[{"type":"integer","name":"Session ID","mask":63,"shift":0},{"type":"bool","name":"Reserved","mask":64,"shift":6},{"type":"bool","name":"More Status Updates","mask":128,"shift":7}]},{"type":"enum","name":"Status","length":1,"values":{"0":"NO_SUPPORT","1":"WORKING","2":"FAIL","3":"BUSY","255":"SUCCESS"}},{"type":"integer","name":"Duration","length":1}]}]};
}
