...
export class CommandClassSwitchMultilevelV2 {
	public static readonly commandClass = 0x26; // (38);
	public static readonly definition = {"id":38,"name":"COMMAND_CLASS_SWITCH_MULTILEVEL","status":"active","version":2,"commands":[{"id":2,"name":"SWITCH_MULTILEVEL_GET","status":"active","params":[]},{"id":3,"name":"SWITCH_MULTILEVEL_REPORT","status":"active","params":[{"type":"integer","name":"Value","length":1,"values":{"0":"off/disable","255":"on/enable"}}]},{"id":1,"name":"SWITCH_MULTILEVEL_SET","status":"active","params":[{"type":"integer","name":"Value","length":1,"values":{"0":"off/disable","255":"on/enable"}},{"type":"integer","name":"Dimming Duration","length":1,"values":{"0":"Instantly","255":"Factory default"}}]},{"id":4,"name":"SWITCH_MULTILEVEL_START_LEVEL_CHANGE","status":"active","params":[{"type":"bitfield","name":"Properties1","length":1,"fields":[{"type":"integer","name":"Reserved1","mask":31,"shift":0},{"type":"bool","name":"Ignore Start Level","mask":32,"shift":5},{"type":"bool","name":"Up/ Down","mask":64,"shift":6},{"type":"bool","name":"Reserved2","mask":128,"shift":7}]},{"type":"integer","name":"Start Level","length":1},{"type":"integer","name":"Dimming Duration","length":1}]},{"id":5,"name":"SWITCH_MULTILEVEL_STOP_LEVEL_CHANGE","status":"active","params":[]}]};
}
