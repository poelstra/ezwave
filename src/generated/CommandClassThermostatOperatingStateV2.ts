...
export class CommandClassThermostatOperatingStateV2 {
	...
	public static readonly definition = {"id":66,"name":"COMMAND_CLASS_THERMOSTAT_OPERATING_STATE","status":"active","version":2,"commands":[{"id":2,"name":"THERMOSTAT_OPERATING_STATE_GET","status":"active","params":[]},{"id":3,"name":"THERMOSTAT_OPERATING_STATE_REPORT","status":"active","params":[{"type":"bitfield","name":"Properties1","length":1,"fields":[{"type":"enum","name":"Operating State","mask":15,"shift":0,"values":{"0":"Idle","1":"Heating","2":"Cooling","3":"Fan Only","4":"Pending Heat","5":"Pending Cool","6":"Vent/Economizer","7":"Aux Heating","8":"2nd Stage Heating","9":"2nd Stage Cooling","10":"2nd Stage Aux Heat","11":"3rd Stage Aux Heat"}},{"type":"integer","name":"Reserved","mask":240,"shift":4}]}]},{"id":1,"name":"THERMOSTAT_OPERATING_STATE_LOGGING_SUPPORTED_GET","status":"active","params":[]},{"id":4,"name":"THERMOSTAT_OPERATING_LOGGING_SUPPORTED_REPORT","status":"active","params":[{"type":"integer","name":"Bit Mask","length":0}]},{"id":5,"name":"THERMOSTAT_OPERATING_STATE_LOGGING_GET","status":"active","params":[{"type":"integer","name":"Bit Mask","length":0}]},{"id":6,"name":"THERMOSTAT_OPERATING_STATE_LOGGING_REPORT","status":"active","params":[{"type":"integer","name":"Reports to Follow","length":1},{"type":"group","name":"vg1","length":{"name":"Reports to Follow","mask":255,"shift":0},"params":[{"type":"bitfield","name":"Properties1","length":1,"fields":[{"type":"integer","name":"Operating State Log Type","mask":15,"shift":0},{"type":"integer","name":"Reserved","mask":240,"shift":4}]},{"type":"integer","name":"Usage Today (Hours)","length":1},{"type":"integer","name":"Usage Today (Minutes)","length":1},{"type":"integer","name":"Usage Yesterday (Hours)","length":1},{"type":"integer","name":"Usage Yesterday (Minutes)","length":1}]}]}]};
}
