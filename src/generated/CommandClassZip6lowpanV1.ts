...
export class CommandClassZip6lowpanV1 {
	...
	public static readonly definition = {"id":79,"name":"COMMAND_CLASS_ZIP_6LOWPAN","status":"active","version":1,"commands":[{"id":192,"name":"LOWPAN_FIRST_FRAGMENT","status":"active","cmdMask":248,"params":[{"type":"bitfield","name":"Properties1","length":1,"fields":[{"type":"integer","name":"Datagram Size 1","mask":7,"shift":0}],"cmdMask":7},{"type":"integer","name":"Datagram Size 2","length":1},{"type":"integer","name":"Datagram Tag","length":1},{"type":"blob","name":"Payload","length":"auto"}]},{"id":224,"name":"LOWPAN_SUBSEQUENT_FRAGMENT","status":"active","cmdMask":248,"params":[{"type":"bitfield","name":"Properties1","length":1,"fields":[{"type":"integer","name":"Datagram Size 1","mask":7,"shift":0}],"cmdMask":7},{"type":"integer","name":"Datagram Size 2","length":1},{"type":"integer","name":"Datagram Tag","length":1},{"type":"integer","name":"Datagram Offset","length":1},{"type":"blob","name":"Payload","length":"auto"}]}]};
}
