...
export class MeterTblMonitorV2 extends CommandClassPacket<MeterTblMonitorV2Commands> {
	...
	public static readonly MeterTblStatusReport = class MeterTblStatusReport extends CommandPacket<MeterTblMonitorV2MeterTblStatusReportData> {
		...
		constructor(data: Buffer | MeterTblMonitorV2MeterTblStatusReportData) {
			super(MeterTblStatusReport, data);
		}
	};

	public static readonly MeterTblStatusDateGet = class MeterTblStatusDateGet extends CommandPacket<MeterTblMonitorV2MeterTblStatusDateGetData> {
		public static readonly CommandClass = MeterTblMonitorV2;
		...
		constructor(data: Buffer | MeterTblMonitorV2MeterTblStatusDateGetData) {
			super(MeterTblStatusDateGet, data);
		}
	};

	public static readonly MeterTblStatusDepthGet = class MeterTblStatusDepthGet extends CommandPacket<MeterTblMonitorV2MeterTblStatusDepthGetData> {
		public static readonly CommandClass = MeterTblMonitorV2;
		...
		constructor(data: Buffer | MeterTblMonitorV2MeterTblStatusDepthGetData) {
	...
	public static readonly MeterTblStatusSupportedReport = class MeterTblStatusSupportedReport extends CommandPacket<MeterTblMonitorV2MeterTblStatusSupportedReportData> {
		public static readonly CommandClass = MeterTblMonitorV2;
		...
		constructor(data: Buffer | MeterTblMonitorV2MeterTblStatusSupportedReportData) {
			super(MeterTblStatusSupportedReport, data);
		}
	};

	public static readonly MeterTblCurrentDataGet = class MeterTblCurrentDataGet extends CommandPacket<MeterTblMonitorV2MeterTblCurrentDataGetData> {
		public static readonly CommandClass = MeterTblMonitorV2;
		...
		constructor(data: Buffer | MeterTblMonitorV2MeterTblCurrentDataGetData) {
	...
	public static readonly MeterTblCurrentDataReport = class MeterTblCurrentDataReport extends CommandPacket<MeterTblMonitorV2MeterTblCurrentDataReportData> {
			...
			"params": [
				...
				},
				{
					...
					"fields": [
						...
						{
							"type": "boolean",
							"name": "Operating Status Indication",
							"mask": 128,
							"shift": 7
						}
					]
		...
		constructor(data: Buffer | MeterTblMonitorV2MeterTblCurrentDataReportData) {
			super(MeterTblCurrentDataReport, data);
		}
	};

	public static readonly MeterTblHistoricalDataGet = class MeterTblHistoricalDataGet extends CommandPacket<MeterTblMonitorV2MeterTblHistoricalDataGetData> {
		public static readonly CommandClass = MeterTblMonitorV2;
		...
		constructor(data: Buffer | MeterTblMonitorV2MeterTblHistoricalDataGetData) {
	...
	public static readonly MeterTblHistoricalDataReport = class MeterTblHistoricalDataReport extends CommandPacket<MeterTblMonitorV2MeterTblHistoricalDataReportData> {
		...
		constructor(data: Buffer | MeterTblMonitorV2MeterTblHistoricalDataReportData) {
			super(MeterTblHistoricalDataReport, data);
		}
	};

	public static readonly MeterTblReport = class MeterTblReport extends CommandPacket<MeterTblMonitorV2MeterTblReportData> {
		public static readonly CommandClass = MeterTblMonitorV2;
		...
		constructor(data: Buffer | MeterTblMonitorV2MeterTblReportData) {
	...
	public static readonly MeterTblTableIdReport = class MeterTblTableIdReport extends CommandPacket<MeterTblMonitorV2MeterTblTableIdReportData> {
		public static readonly CommandClass = MeterTblMonitorV2;
		...
		constructor(data: Buffer | MeterTblMonitorV2MeterTblTableIdReportData) {
	...
	public static readonly MeterTblTablePointAdmNoReport = class MeterTblTablePointAdmNoReport extends CommandPacket<MeterTblMonitorV2MeterTblTablePointAdmNoReportData> {
		public static readonly CommandClass = MeterTblMonitorV2;
		...
		constructor(data: Buffer | MeterTblMonitorV2MeterTblTablePointAdmNoReportData) {
			super(MeterTblTablePointAdmNoReport, data);
		}
	};
}

export namespace MeterTblMonitorV2 {
	export type MeterTblStatusReport = InstanceType<typeof MeterTblMonitorV2.MeterTblStatusReport>;
	export type MeterTblStatusDateGet = InstanceType<typeof MeterTblMonitorV2.MeterTblStatusDateGet>;
	export type MeterTblStatusDepthGet = InstanceType<typeof MeterTblMonitorV2.MeterTblStatusDepthGet>;
	export type MeterTblStatusSupportedGet = InstanceType<typeof MeterTblMonitorV2.MeterTblStatusSupportedGet>;
	export type MeterTblStatusSupportedReport = InstanceType<typeof MeterTblMonitorV2.MeterTblStatusSupportedReport>;
	export type MeterTblCurrentDataGet = InstanceType<typeof MeterTblMonitorV2.MeterTblCurrentDataGet>;
	export type MeterTblCurrentDataReport = InstanceType<typeof MeterTblMonitorV2.MeterTblCurrentDataReport>;
	export type MeterTblHistoricalDataGet = InstanceType<typeof MeterTblMonitorV2.MeterTblHistoricalDataGet>;
	export type MeterTblHistoricalDataReport = InstanceType<typeof MeterTblMonitorV2.MeterTblHistoricalDataReport>;
	export type MeterTblReport = InstanceType<typeof MeterTblMonitorV2.MeterTblReport>;
	export type MeterTblTableCapabilityGet = InstanceType<typeof MeterTblMonitorV2.MeterTblTableCapabilityGet>;
	export type MeterTblTableIdGet = InstanceType<typeof MeterTblMonitorV2.MeterTblTableIdGet>;
	export type MeterTblTableIdReport = InstanceType<typeof MeterTblMonitorV2.MeterTblTableIdReport>;
	export type MeterTblTablePointAdmNoGet = InstanceType<typeof MeterTblMonitorV2.MeterTblTablePointAdmNoGet>;
	export type MeterTblTablePointAdmNoReport = InstanceType<typeof MeterTblMonitorV2.MeterTblTablePointAdmNoReport>;
}
