/**
 * Command Class Sensor Multilevel, version 8.
 *
...
export enum SensorMultilevelV8Commands {
...
export interface SensorMultilevelV8SensorMultilevelGetData {
	sensorType: SensorTypeEnum; // 1 byte enum value
	scale: number; // properties1[4..3]
}

export interface SensorMultilevelV8SensorMultilevelReportData {
	sensorType: SensorTypeEnum; // 1 byte enum value
...
export interface SensorMultilevelV8SensorMultilevelSupportedScaleReportData {
	sensorType: SensorTypeEnum; // 1 byte enum value
...
export class SensorMultilevelV8 extends CommandClassPacket<SensorMultilevelV8Commands> {
	...
	constructor(commandAndPayload: Buffer) {
		super(SensorMultilevelV8, commandAndPayload);
	}

	public static readonly SensorMultilevelGet = class SensorMultilevelGet extends CommandPacket<SensorMultilevelV8SensorMultilevelGetData> {
		...
		static matches(packet: Packet): boolean {
			return packet.tryAs(SensorMultilevelV8)?.command === this.command;
		}

		constructor(data: Buffer | SensorMultilevelV8SensorMultilevelGetData) {
			super(SensorMultilevelGet, data);
		}
	};

	public static readonly SensorMultilevelReport = class SensorMultilevelReport extends CommandPacket<SensorMultilevelV8SensorMultilevelReportData> {
		public static readonly CommandClass = SensorMultilevelV8;
		...
		constructor(data: Buffer | SensorMultilevelV8SensorMultilevelReportData) {
	...
	public static readonly SensorMultilevelSupportedSensorReport = class SensorMultilevelSupportedSensorReport extends CommandPacket<SensorMultilevelV8SensorMultilevelSupportedSensorReportData> {
		...
		constructor(data: Buffer | SensorMultilevelV8SensorMultilevelSupportedSensorReportData) {
			super(SensorMultilevelSupportedSensorReport, data);
		}
	};

	public static readonly SensorMultilevelSupportedGetScale = class SensorMultilevelSupportedGetScale extends CommandPacket<SensorMultilevelV8SensorMultilevelSupportedGetScaleData> {
		public static readonly CommandClass = SensorMultilevelV8;
		...
		constructor(data: Buffer | SensorMultilevelV8SensorMultilevelSupportedGetScaleData) {
			super(SensorMultilevelSupportedGetScale, data);
		}
	};

	public static readonly SensorMultilevelSupportedScaleReport = class SensorMultilevelSupportedScaleReport extends CommandPacket<SensorMultilevelV8SensorMultilevelSupportedScaleReportData> {
		public static readonly CommandClass = SensorMultilevelV8;
		...
		constructor(data: Buffer | SensorMultilevelV8SensorMultilevelSupportedScaleReportData) {
			super(SensorMultilevelSupportedScaleReport, data);
		}
	};
}

export namespace SensorMultilevelV8 {
	export type SensorMultilevelGet = InstanceType<typeof SensorMultilevelV8.SensorMultilevelGet>;
	export type SensorMultilevelReport = InstanceType<typeof SensorMultilevelV8.SensorMultilevelReport>;
	export type SensorMultilevelSupportedGetSensor = InstanceType<typeof SensorMultilevelV8.SensorMultilevelSupportedGetSensor>;
	export type SensorMultilevelSupportedSensorReport = InstanceType<typeof SensorMultilevelV8.SensorMultilevelSupportedSensorReport>;
	export type SensorMultilevelSupportedGetScale = InstanceType<typeof SensorMultilevelV8.SensorMultilevelSupportedGetScale>;
	export type SensorMultilevelSupportedScaleReport = InstanceType<typeof SensorMultilevelV8.SensorMultilevelSupportedScaleReport>;
}
