/**
 * Command Class Sensor Multilevel, version 9.
 *
...
export interface SensorMultilevelV9SensorMultilevelGetData {
	sensorType: SensorTypeEnum; // 1 byte enum value
	scale: number; // properties1[4..3]
}

export interface SensorMultilevelV9SensorMultilevelReportData {
	sensorType: SensorTypeEnum; // 1 byte enum value
...
export interface SensorMultilevelV9SensorMultilevelSupportedSensorReportData {
	// TODO param bitMask type bitmask or marker
}

export interface SensorMultilevelV9SensorMultilevelSupportedGetScaleData {
	sensorType: SensorTypeEnum; // 1 byte enum value
}

export interface SensorMultilevelV9SensorMultilevelSupportedScaleReportData {
	sensorType: SensorTypeEnum; // 1 byte enum value
...
export class SensorMultilevelV9 extends CommandClassPacket<SensorMultilevelV9Commands> {
	...
	constructor(commandAndPayload: Buffer) {
		super(SensorMultilevelV9, commandAndPayload);
	}

	public static readonly SensorMultilevelGet = class SensorMultilevelGet extends CommandPacket<SensorMultilevelV9SensorMultilevelGetData> {
		...
		constructor(data: Buffer | SensorMultilevelV9SensorMultilevelGetData) {
			super(SensorMultilevelGet, data);
		}
	};

	public static readonly SensorMultilevelReport = class SensorMultilevelReport extends CommandPacket<SensorMultilevelV9SensorMultilevelReportData> {
		public static readonly CommandClass = SensorMultilevelV9;
		...
		constructor(data: Buffer | SensorMultilevelV9SensorMultilevelReportData) {
	...
	public static readonly SensorMultilevelSupportedSensorReport = class SensorMultilevelSupportedSensorReport extends CommandPacket<SensorMultilevelV9SensorMultilevelSupportedSensorReportData> {
		...
		constructor(data: Buffer | SensorMultilevelV9SensorMultilevelSupportedSensorReportData) {
			super(SensorMultilevelSupportedSensorReport, data);
		}
	};

	public static readonly SensorMultilevelSupportedGetScale = class SensorMultilevelSupportedGetScale extends CommandPacket<SensorMultilevelV9SensorMultilevelSupportedGetScaleData> {
		public static readonly CommandClass = SensorMultilevelV9;
		...
		constructor(data: Buffer | SensorMultilevelV9SensorMultilevelSupportedGetScaleData) {
			super(SensorMultilevelSupportedGetScale, data);
		}
	};

	public static readonly SensorMultilevelSupportedScaleReport = class SensorMultilevelSupportedScaleReport extends CommandPacket<SensorMultilevelV9SensorMultilevelSupportedScaleReportData> {
		public static readonly CommandClass = SensorMultilevelV9;
		...
		constructor(data: Buffer | SensorMultilevelV9SensorMultilevelSupportedScaleReportData) {
			super(SensorMultilevelSupportedScaleReport, data);
		}
	};
}

export namespace SensorMultilevelV9 {
	export type SensorMultilevelGet = InstanceType<typeof SensorMultilevelV9.SensorMultilevelGet>;
	export type SensorMultilevelReport = InstanceType<typeof SensorMultilevelV9.SensorMultilevelReport>;
	export type SensorMultilevelSupportedGetSensor = InstanceType<typeof SensorMultilevelV9.SensorMultilevelSupportedGetSensor>;
	export type SensorMultilevelSupportedSensorReport = InstanceType<typeof SensorMultilevelV9.SensorMultilevelSupportedSensorReport>;
	export type SensorMultilevelSupportedGetScale = InstanceType<typeof SensorMultilevelV9.SensorMultilevelSupportedGetScale>;
	export type SensorMultilevelSupportedScaleReport = InstanceType<typeof SensorMultilevelV9.SensorMultilevelSupportedScaleReport>;
}
